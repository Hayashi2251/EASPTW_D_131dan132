              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Tuliskan email anda, kami akan mengirimi anda link untuk mengubah passwordnya!</p>
                  </div>
                    @if (session('status'))
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{route('login')}}">Sudah punya akun? Yuk login!</a>
                  </div>
                </div>
              </div>
            </div>
