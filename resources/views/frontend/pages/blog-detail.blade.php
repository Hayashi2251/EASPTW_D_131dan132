                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Bar Sisi Tunggal</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <p class="text-center p-5">
                                Anda harus untuk <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> ATAU <a style="color:blue" href="{{route('register.form')}}">Register</a> untuk berkomentar.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Buletin</h3>
                            <div class="letter-inner">
                                <h4>Berlangganan & dapatkan berita <br> pembaruan terkini.</h4>
