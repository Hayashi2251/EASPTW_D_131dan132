...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Deskripsi Pendek<span class="text-danger">*</span></label>
...
<script>
    ...
    $('#summary').summernote({
      placeholder: "Menulis Deskripsi Pendek.....",
        tabsize: 2,
        height: 150
    });
    });
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Menulis Kutipan Pendek.....",
          tabsize: 2,
          height: 100
      });
    });
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "Menulis Detail Deskripsi.....",
          tabsize: 2,
          height: 150
      });
    });
