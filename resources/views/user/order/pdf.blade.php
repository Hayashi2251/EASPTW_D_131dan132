...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>{{env('APP_ADDRESS')}}</p>
      <p>Telp: <a href="tel:{{env('APP_PHONE')}}">{{env('APP_PHONE')}}</a></p>
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          ...
          <th scope="col" class="col-3">Quantitas</th>
      ...
      @endif --}}
        <tr>
          <th scope="col" class="empty"></th>
          <th scope="col" class="text-right ">Pengiriman:</th>
  ...
  <div class="thanks mt-3">
    <h4>Terimakasih sudah order dan berbelanja !!</h4>
  </div>
