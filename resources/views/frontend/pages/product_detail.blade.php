...
@endsection
@section('title','E-SHOP || DETAIL PRODUK')
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Opsi <span>Color</span> yang Tersedia </h4>
												<ul>
													...
													<div class="tab-single review-panel">
														<div class="row">
															<div class="col-12">
																...
																Anda harus untuk <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('register.form')}}">Register</a>
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Belanja Cepat</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Tambahkan ke Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Tambah untuk komparasi</span></a>
                                            </div>
                        ...
                        <div class="quickview-content">
                            ...
                            <div class="quickview-ratting-review">
                                <div class="quickview-ratting-wrap">
                                    ...
                                    <a href="#"> (1 review customer)</a>
                                </div>
                                <div class="quickview-stock">
                                    <span><i class="fa fa-check-circle-o"></i> Dalam stok</span>
                                </div>
                            </div>
                            <h3>Rp.29.000</h3>
