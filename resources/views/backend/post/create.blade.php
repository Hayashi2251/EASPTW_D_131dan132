...
<div class="card">
    <h5 class="card-header">Tambahkan Post</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Kuotasi</label>
        ...
        <div class="form-group">
          ...
          <select name="post_cat_id" class="form-control">
              <option value="">--Pilih beberapa kategori--</option>
        ...
        <div class="form-group">
          ...
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--pilih beberapa tag--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "tulis detail kuotasi.....",
          tabsize: 2,
          height: 150
      });
    });
