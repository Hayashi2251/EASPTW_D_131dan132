...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">List Komentar</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Tidak ada komentar post ditemukan!!!</h6>
        @endif
      </div>
    </div>
</div>
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    ...
                    text: "Setelah di delete, data ini tidak dapat di recover!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
