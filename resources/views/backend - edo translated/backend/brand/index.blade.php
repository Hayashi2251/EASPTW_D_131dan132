...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">List Brand</h6>
      <a href="{{route('brand.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Tambah Brand</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ route('banners.destroy',$user->id) }}">
                                @csrf 
                                @method('delete')
                                <button type="submit" class="btn btn-danger" style="margin:auto; text-align:center">Delete Permanent User</button>
                              </form>
                            </div>
                          </div>
                        </div>
        ...
        @else
          <h6 class="text-center">tidak ada brand ditemukan, mohon buat brand!</h6>
        @endif
      </div>
    </div>
</div>
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    ...
                    text: "setelah dihapus, data ini tidak dapat di recover!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
