...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">List Pengiriman</h6>
      <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Tampah Pengiriman</a>
    </div>
    <div class="card-body">
                ...
                .then((willDelete) => {
                    if (willDelete) {
                       form.submit();
                        ...
                        swal("Data anda aman dan tersimpan!");
                    }
                });
          })
      })
