...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Hubungi Kami</h4>
									<h3>Tulis pesan kepada kami @auth @else<span style="font-size:12px;" class="text-danger">[Anda harus Login terlebih dahulu]</span>@endauth</h3>
								</div>
								<form class="form-contact form contact_form" method="post" action="{{route('contact.store')}}" id="contactForm" novalidate="novalidate">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Subjek Anda<span>*</span></label>
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Nomor Telepon Anda<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="Masukkan nomor telepon anda">
											</div>	
										</div>
										<div class="col-12">
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-success">Terimakasih ^_^ !</h2>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-warning">Maaf ( ;_; )!</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
